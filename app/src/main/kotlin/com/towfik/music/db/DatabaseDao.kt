...
import com.towfik.music.constants.AlbumSortType
import com.towfik.music.constants.ArtistSongSortType
import com.towfik.music.constants.ArtistSortType
import com.towfik.music.constants.PlaylistSortType
import com.towfik.music.constants.SongSortType
import com.towfik.music.db.entities.Album
import com.towfik.music.db.entities.AlbumArtistMap
import com.towfik.music.db.entities.AlbumEntity
import com.towfik.music.db.entities.PlayCountEntity
import com.towfik.music.db.entities.AlbumWithSongs
...
import com.towfik.music.db.entities.EventWithSong
...
import com.towfik.music.db.entities.SetVideoIdEntity
import com.towfik.music.db.entities.Song
import com.towfik.music.db.entities.SongAlbumMap
import com.towfik.music.db.entities.SongArtistMap
import com.towfik.music.db.entities.SongEntity
import com.towfik.music.db.entities.SongWithStats
import com.towfik.music.db.entities.TagEntity
import com.towfik.music.db.entities.PlaylistTagMap
import com.towfik.music.db.entities.PlaylistWithTags
import com.towfik.music.extensions.reversed
import com.towfik.music.extensions.toSQLiteQuery
import com.towfik.music.models.MediaMetadata
import com.towfik.music.models.toMediaMetadata
import com.towfik.music.ui.utils.resize
...
interface DatabaseDao {
    ...
    fun getAllSkips(): Flow<List<com.towfik.music.db.entities.SongSkipEntity>>

    @Query("SELECT * FROM song_skip WHERE songId = :songId LIMIT 1")
    suspend fun getSkip(songId: String): com.towfik.music.db.entities.SongSkipEntity?

    @Upsert
    suspend fun upsertSkip(skip: com.towfik.music.db.entities.SongSkipEntity)
