...
package com.towfik.music.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.towfik.music.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.towfik.music.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.towfik.music.together.JoinDecision -> {
