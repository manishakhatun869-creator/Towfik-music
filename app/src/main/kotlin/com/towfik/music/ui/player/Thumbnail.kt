...
import com.towfik.music.canvas.VeluneCanvas
import com.towfik.music.canvas.CanvasArtwork
import com.towfik.music.constants.PlayerBackgroundStyle
import com.towfik.music.constants.PlayerBackgroundStyleKey
import com.towfik.music.constants.PlayerHorizontalPadding
...
import com.towfik.music.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.towfik.music.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.towfik.music.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
